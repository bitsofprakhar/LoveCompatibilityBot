...
def generate():
    ...
    person1_gender = request.form.get('person1_gender', 'Not specified')
    ...
    person2_gender = request.form.get('person2_gender', 'Not specified')
...
Person 1: {person1_name}, Gender: {person1_gender}, Bio: {person1_bio}, Zodiac: {person1_zodiac}
Person 2: {person2_name}, Gender: {person2_gender}, Bio: {person2_bio}, Zodiac: {person2_zodiac}
